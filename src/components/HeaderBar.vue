<template>
    <div class="headerBar">
         <h1 class="title">
            <router-link :to="{ name: 'RootView'}">
                豆瓣
            </router-link>
        </h1>
        <ul class="navBar">
            <li><router-link style="color: #2384E8" :to="{ name: 'MovieView'}">
          电影
        </router-link></li>
            <li><router-link style="color: #9F7860" :to="{ name: 'MovieView'}">
          图书
        </router-link></li>
            <li><router-link style="color: #E4A813" :to="{ name: 'MovieView'}">
          广播
        </router-link></li>
            <li><router-link style="color: #2AB8CC" :to="{ name: 'MovieView'}">
          小组
        </router-link></li>
        </ul>
